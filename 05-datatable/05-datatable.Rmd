...
The only other thing I'll point out is that [keys](#keys) (remember those?) can lead to dramatic speed-ups for merging data.tables. I'll demonstrate using an inner join this time.
...
.footnote[<sup>1</sup> Remember my [admonition](https://raw.githack.com/uo-ec510-2020-spring/lectures/master/04-tidyverse/04-tidyverse.html#11) from last time: "A combination of tidyverse and base R is often the best solution to a problem." Add data.table to that list.]

--

Plus, as I hinted earlier, you *can* use tidyverse verbs on data.tables. Try this yourself:
...
*Note:* Using dplyr verbs on data.tables will [cause](https://stackoverflow.com/a/27513921) a performance drop... but, luckily there's a better solution on the next slide. 
