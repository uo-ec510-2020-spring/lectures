...
Lastly, combining `mutate` with the new `across` feature in dplyr 1.0.0 (or the development that you should've installed) allows you to easily work on a subset of variables, e.g.:
